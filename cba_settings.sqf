...
// ACE Cookoff (Explodieren von Munition in Fahrzeugen)
...
force force ace_overheating_unJamFailChance = 0.3;
...
force force ace_medical_enableFractures = true;
...
force force adv_aceCPR_chance_aed = 75;
...
force force adv_aceSplint_reopenChance_medic = 5;
force force adv_aceSplint_reopenChance_regular = 25;
force force adv_aceSplint_reopenTime = 800;
...
force force L_Suppress_flyByIntensity = 1.15419;
force force L_Suppress_halting = true;
force force L_Suppress_intensity = 0.686273;
